...
,
		"rect" : [ 810.0, 630.0, 300.0, 105.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 103.0, 113.0, 871.0, 614.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 296.0, 526.0, 183.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 20.0, 501.0, 250.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 283.0, 224.0, 313.0, 55.0 ],
					"text" : "jcom.parameter color @type array @ramp/drive scheduler @description \"set the color of the screen (if mode equal 1)\" @ramp/function linear @repetitions/allow 1 @value/default 0.5 0.5 0.5 0.5",
					"varname" : "deformB[2]"
				}
...
,
						...
						"bglocked" : 0,
						"defrect" : [ 726.0, 412.0, 365.0, 365.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.0, 520.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 520.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 18.0, 585.0, 232.0, 55.0 ],
									"text" : "jcom.parameter scale @type array @ramp/drive scheduler @description \"scale the screen\" @ramp/function linear @repetitions/allow 1 @value/default 1. 1. 1.",
									"varname" : "deformB[1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 102.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 58.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 195.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 287.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 243.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 379.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 335.0, 87.0, 32.0, 14.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 507.0, 253.0, 21.0, 62.0 ],
									"presentation" : 1,
									"presentation_linecount" : 4,
									"presentation_rect" : [ 342.0, 153.0, 21.0, 62.0 ],
									"text" : "Z\nO\nO\nM",
									"textcolor" : [ 1.0, 1.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 519.0, 77.0, 151.0, 87.0 ],
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 134.0, 649.0, 9.25, 649.0, 9.25, 487.0, 28.5, 487.0 ],
									"source" : [ "obj-23", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter corner/upper.left @type array @ramp/drive scheduler @description \"deform upper.left corner\" @dataspace position @dataspace/unit/native xy @ramp/function linear @repetitions/allow 1",
					"varname" : "deformA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 475.0, 435.0, 372.0, 43.0 ],
					"text" : "jcom.parameter corner/lower.right @type array @ramp/drive scheduler @description \"deform lower.right corner\" @dataspace position @dataspace/unit/native xy @ramp/function linear @repetitions/allow 1",
					"varname" : "deformD"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 476.0, 386.0, 373.0, 43.0 ],
					"text" : "jcom.parameter corner/upper.right @type array @ramp/drive scheduler @description \"deform upper.right corner\" @dataspace position @dataspace/unit/native xy @ramp/function linear @repetitions/allow 1",
					"varname" : "deformB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 17.0, 433.0, 368.0, 43.0 ],
					"text" : "jcom.parameter corner/lower.left @type array @ramp/drive scheduler @description \"deform lower.left corner\" @dataspace position @dataspace/unit/native xy @ramp/function linear @repetitions/allow 1",
					"varname" : "deformC"
				}
