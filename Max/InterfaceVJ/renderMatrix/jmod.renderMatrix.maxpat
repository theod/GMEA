...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 333.0, 343.0, 327.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 333.0, 293.0, 314.0, 43.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 511.0, 24.0, 268.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 335.0, 520.0, 297.0, 43.0 ],
					"text" : "jcom.parameter matrix/dimension @type integerArray @value/default 640 480 @description \"dimension of the render matrix\" @priority 2"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "jalg.renderMatrix.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/UserLib/GMEA/Max/InterfaceVJ/renderMatrix",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
