...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "Synapse depth map colored matrix",
					"id" : "obj-14",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"annotation" : "turn on/off gl rebuilding of the depth matrix",
...
, 			{
				"box" : 				{
					"annotation" : "",
					"comment" : "Synapse depth map matrix",
					"hint" : "",
					"id" : "obj-2",
					"maxclass" : "outlet",
					"numinlets" : 1,
