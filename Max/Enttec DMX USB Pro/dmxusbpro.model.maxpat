...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2.0, 29.0, 831.0, 20.0 ],
					"text" : "jcom.model @description \"send or receive DMX data through the DMX USB Pro Interface made by Enttec (http://www.enttec.com/dmxusb_pro.php)\""
				}
