...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 14.636368, 30.0, 20.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 262.954529, 11.636368, 27.090912, 27.090912 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 233.590912, 140.0, 33.0 ],
					"text" : "a transparent icon to display in render matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 66.181824, 140.0, 33.0 ],
					"text" : "a transparent sphere to display in render matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 688.5, 146.181824, 148.0, 33.0 ],
					"text" : "j.receive /renderMatrix/render/draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.5, 183.181824, 127.0, 20.0 ],
					"text" : "loadmess read icon.tif"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 688.5, 233.590912, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 688.5, 208.090912, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.0, 262.590912, 77.0, 31.0 ],
					"text" : "layer 1, scale 0.4 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.0, 305.0, 103.5, 33.0 ],
					"text" : "plane.model icon /renderMatrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 604.0, 26.181824, 148.0, 33.0 ],
					"text" : "j.receive /renderMatrix/render/draw"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "j.receive /renderWindow/render/draw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 8.681824, 220.0, 33.0 ],
					"text" : "How to display a rendered matrix as plane texture in render window"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.0, 62.090912, 187.0, 17.0 ],
					"text" : "reset, color 0. 1. 0. 0.7, sphere 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 604.0, 82.090912, 201.0, 33.0 ],
					"text" : "jit.gl.sketch renderMatrix @depth_enable 0 @blend_enable 1"
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.892897, 0.892897, 0.892897, 0.9 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "renderMatrix.model.maxpat",
				"bootpath" : "/Users/WALL-E/Documents/Jamoma/UserLib/GMEA/Max/Picture/renderMatrix",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
