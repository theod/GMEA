...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 536.0, 241.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 283.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 130.0, 63.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 231.0, 186.660461, 61.0, 20.0 ],
					"text" : "route dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "clear" ],
					"patching_rect" : [ 493.0, 241.0, 43.0, 20.0 ],
					"text" : "t clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 241.0, 98.0, 20.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 383.0, 284.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 72.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 241.0, 98.0, 20.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 284.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 54.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 273.0, 212.0, 349.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 150.0, 189.0, 20.0 ],
					"text" : "jalg.SyphonClient"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 146.0, 180.0, 80.0, 60.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 109.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 24.0, 66.0, 17.0 ],
					"text" : "Render",
					"texton" : "Rendering"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 24.0, 68.0, 17.0 ],
					"rounded" : 2.0,
					"tabmode" : 0,
					"text" : "glWindow",
					"wordwrap" : 0
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 502.5, 271.0, 392.5, 271.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 502.5, 271.0, 282.5, 271.0 ],
					"source" : [ "obj-29", 0 ]
				}
