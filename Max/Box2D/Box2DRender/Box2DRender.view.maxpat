...
,
		"rect" : [ 501.0, 44.0, 550.0, 325.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 501.0, 44.0, 550.0, 325.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 299.0, 62.0, 19.0 ],
					"text" : "delta time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 172.0, 299.0, 48.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 172.0, 276.0, 163.0, 19.0 ],
					"text" : "jcom.remote render/deltatime"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-2",
					"items" : [ "everything", ",", "body", ",", "shape", ",", "contact" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 175.0, 184.0, 100.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 45.0, 137.0, 19.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 216.0, 208.0, 132.0, 19.0 ],
					"text" : "jcom.remote render/get"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 67.0, 34.0, 19.0 ],
					"text" : "fps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 67.0, 36.0, 18.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 162.0, 37.0, 61.0, 19.0 ],
					"text" : "jcom.view",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 10.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 62.0, 22.0, 22.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 225.5, 232.0, 171.0, 232.0, 171.0, 179.0, 184.5, 179.0 ],
					"source" : [ "obj-1", 0 ]
				}
